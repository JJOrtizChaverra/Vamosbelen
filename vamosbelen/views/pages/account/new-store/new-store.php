            ...
            <div class="ps-section__content">
                ...
                <div class="ps-page__content text-center row">
                    ...
                    <div class="container">
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-warning btn-lg" data-toggle="tab" href="#terms" onclick="goTerms()"><span class="badge badge-secondary">1</span> Accept terms and conditions</button>
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-warning btn-lg disabled btn-create-store"><span class="badge badge-secondary">2</span> Create Store</button>
                            ...
                            <div class="col-lg-4 col-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <button class="btn btn-warning btn-lg disabled btn-create-product"><span class="badge badge-secondary">3</span> Create Product</button>
                        ...
                        <!-- Modulos para la creacion de nueva tienda -->
                        ...
                        <form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content" id="tab-content">
                                ...
                                <?php include "modules/form-store.php"; ?>
                                <?php include "modules/form-product.php"; ?>
