<div id="showcase" class="ps-shopping ps-tab-root">
    ...
    <div class="ps-shopping__header">
        ...
        <p><strong><?php echo $total_products ?></strong> Products found</p>
    ...
    <div class="preload-false ps-tabs">
        ...
        <?php if (isset($_COOKIE['tab'])) : ?>
            <?php if ($_COOKIE['tab'] == "grid") : $_COOKIE['tab'] = "grid"; ?>
                ...
                <?php else : ?>
                    ...
                    <div class="ps-shopping-product">
                        ...
                        <div class="row">
                            ...
                            <?php foreach ($showcase_products as $key => $value) : ?>
                    ...
                    <div class="ps-pagination">
                        ...
                        <ul class="pagination" data-total-pages="<?php echo ceil($total_products / 6) ?>" data-current-page="<?php echo $current_page ?>" data-url-page="<?php echo $_SERVER['REQUEST_URI']; ?>">
                    ...
                    <?php if (isset($_COOKIE['tab'])) : ?>
                        <?php if ($_COOKIE['tab'] == "list") : $_COOKIE['tab'] = "list"; ?>
                                        ...
                                        <div class="ps-product ps-product--wide">
                                            ...
                                            <div class="ps-product__container">
                                                ...
                                                <div class="ps-product__shopping">
                                                    ...
                                                    <a class="ps-btn" onclick="addShoppingCart('<?php echo $value->url_product; ?>', '<?php echo CurlController::api(); ?>', '<?php echo $_SERVER['REQUEST_URI'] ?>', this)" details-sc quantity-sc>Add to cart</a>
