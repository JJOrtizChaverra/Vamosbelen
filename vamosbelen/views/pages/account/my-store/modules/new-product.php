...
<form class="needs-validation" novalidate method="post" enctype="multipart/form-data">
    ...
    <div>
        ...
        <div class="modal-header">
            <h4 class="modal-title text-center">Create a new product</h4>
        ...
        <div class="modal-body p-5 text-left">
            ...
            <div class="modal-footer">
                <div class="form-group submtit">
                    <button type="submit" class="ps-btn ps-btn--fullwidth save-btn">Create Product</button>

                    <?php
                    $new_product = new VendorsController();
                    $new_product->new_product($store[0]->id_store);
                    ?>
                </div>
            </div>
        </div>
